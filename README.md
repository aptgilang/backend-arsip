...
Sistem backend untuk manajemen arsip menggunakan Bun, Hono.js, dan Supabase sebagai database.

## 🚀 Features

- **Authentication & Authorization**: Registrasi, login, logout dengan Supabase Auth
- **Archive Management**: CRUD operations untuk item arsip
- **File Storage**: Upload dan manajemen file dengan Supabase Storage
- **Role-based Access Control**: User dan Admin roles
- **Admin Dashboard**: Statistics dan manajemen pengguna
- **Search Functionality**: Pencarian arsip berdasarkan title dan description
- **RESTful API**: Endpoint yang terstruktur dan documented
